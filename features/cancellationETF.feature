...
#      | Bill Cycle Day          | VALIDATE  |       |
    ...
    When I click submit for cancellation with ETF
...
#      | Payment Status | IS_EQUAL  | Processed |
    @CancellationETFUK @FullCancellationETFUK
    Examples:
      | Source Country |
      | GBR            |
    @CancellationETFIRL @FullCancellationETFIRL
    Examples:
      | Source Country |
      | IRL            |
...
#      | ETF amount     | VALIDATE  |           |
#      | Payment Status | IS_EQUAL  | Processed |
    @CancellationETFUK @PartialCancellationETFUK
    Examples:
      | Source Country |
      | GBR            |
    @CancellationETFIRL @PartialCancellationETFIRL
    Examples:
      | Source Country |
      | IRL            |